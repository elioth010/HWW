...
public class GetHistoricoSensorTask extends AbstractGetTask<Void, Void, List<BitacoraDTO>> {

    protected AbstractActivity parentActivity;
    protected List<BitacoraDTO> bitacora;
    public GetHistoricoSensorTask(AbstractActivity parentActivity) {
    ...
    protected List<BitacoraDTO> doInBackground(Void... params) {
        ...
        try {
            String url = super.BASE_URL + "bitacora/historico";
